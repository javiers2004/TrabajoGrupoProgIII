...
public class Slime extends Enemigos{
	...
	public Slime() {
		...
		ImageIcon icono11 = new ImageIcon("TrabajoGrupoProgIII/src/Imagenes/slime-die-0.png");
		ImageIcon image11 = new ImageIcon(icono11.getImage().getScaledInstance(60,45, Image.SCALE_SMOOTH));
		ImageIcon icono12 = new ImageIcon("TrabajoGrupoProgIII/src/Imagenes/slime-die-1.png");
		ImageIcon image12 = new ImageIcon(icono12.getImage().getScaledInstance(60,45, Image.SCALE_SMOOTH));
		ImageIcon icono13 = new ImageIcon("TrabajoGrupoProgIII/src/Imagenes/slime-die-2.png");
