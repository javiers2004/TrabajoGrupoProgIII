...
public class Jugador {
	...
	public Jugador() {
		...
		ImageIcon imagen8 = new ImageIcon(icono8.getImage().getScaledInstance(40,40, Image.SCALE_SMOOTH));
		...
		ImageIcon imagen10 = new ImageIcon(icono10.getImage().getScaledInstance(40,40, Image.SCALE_SMOOTH));
